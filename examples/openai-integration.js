 ...
 */
async function tracedChatCompletion(openai, params, traceName = 'openai-chat') {
    // Start trace
 ...
 */
async function tracedToolCall(openai, params, traceName = 'openai-tool-call') {
    const trace = amp.trace(traceName);
    ...
    toolSpan.setTool('get_weather', { location: 'San Francisco' }, { temperature: 72, conditions: 'sunny' });
    // Simulate tool call
