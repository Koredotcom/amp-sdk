...
async function main() {
    ...
    turn1Llm.setMessages([{ role: 'user', content: 'What features does your AI platform offer?' }], [{ role: 'assistant', content: 'Our AI platform offers real-time observability, multi-model support for OpenAI, Anthropic, and more, plus comprehensive monitoring capabilities.' }]);
    ...
    turn2Tool.setTool('pricing_api', { plan_type: 'all', include_enterprise: true }, {
        plans: [
    ...
    turn2Llm.setMessages([{ role: 'user', content: 'What are your pricing plans?' }], [{ role: 'assistant', content: 'We offer three plans: Starter at $99/mo, Pro at $299/mo, and Enterprise with custom pricing.' }]);
    ...
    turn3Llm.setMessages([{ role: 'user', content: 'Can I schedule a demo?' }], [{ role: 'assistant', content: 'Absolutely! I\'ve scheduled a demo for you. You\'ll receive a calendar invite shortly.' }]);
