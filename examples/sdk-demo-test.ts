...
async function main() {
  ...
  toolSpan.setTool('google_search',
    { query: 'latest AI observability tools 2024', num_results: 5 },
    { results: [
  ...
  turn1Llm.setMessages(
    ...
    [{ role: 'assistant', content: 'Our AI platform offers real-time observability, multi-model support, and comprehensive monitoring capabilities.' }]
  );
  ...
  turn2Tool.setTool('pricing_api',
    { plan_type: 'enterprise' },
    { plans: ['Starter: $99/mo', 'Pro: $299/mo', 'Enterprise: Custom'] }
  );
  ...
  turn2Llm.setMessages(
    ...
    [{ role: 'assistant', content: 'We offer Starter at $99/mo, Pro at $299/mo, and custom Enterprise pricing.' }]
  );
  ...
  turn3Llm.setMessages(
    ...
    [{ role: 'assistant', content: 'Absolutely! I have scheduled a demo for you. You will receive a calendar invite shortly.' }]
  );
